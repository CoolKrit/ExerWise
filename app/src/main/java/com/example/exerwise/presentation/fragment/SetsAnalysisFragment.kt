...
class SetsAnalysisFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_sets_analysis, container, false)
        ...
        viewModel.workouts.observe(viewLifecycleOwner, Observer { workouts ->
            ...
            workouts.forEachIndexed { index, workout ->
                entries.add(BarEntry(index.toFloat(), workout.sets.toFloat()))
                labels.add(formatDate(workout.id))
            }

            val dataSet = BarDataSet(entries, "Sets")
